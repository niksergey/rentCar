        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <c:forEach items="${requestScope.carModels}" var="cm">
                        <tr>
                            <td><c:out value="${cm.getId()}"/></td>
                            <td><c:out value="${cm.getManufacturer()}"/></td>
                            <td><c:out value="${cm.getModel()}"/></td>
                            <td><c:out value="${cm.getPower()}"/></td>
                            <td><c:out value="${cm.getGear()}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
