...
<t:genericpage>
    ...
    <jsp:body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Модель автомобиля</h1>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">${carModel.id}</div>
            </div>

            <div class="row">
                <label class="col-sm-2">Марка</label>
                <div class="col-sm-10">${carModel.manufacturer}</div>
            </div>

            <div class="row">
                <label class="col-sm-2">Модель</label>
                <div class="col-sm-10">${carModel.model}</div>
            </div>

            <div class="row">
                <label class="col-sm-2">Мощность</label>
                <div class="col-sm-10">${carModel.power}</div>
            </div>

            <div class="row">
                <label class="col-sm-2">Коробка передач</label>
                <div class="col-sm-10">${carModel.gear}</div>
            </div>
        </div>
    </jsp:body>
</t:genericpage>